import { useEffect,useState,useContextC } from "react";
            ...
            >
                ...
                md:space-y-0">
                    {navigation.map((item,idx)=>{
                        return(
                            <li key={idx} className="text-gray-700 hiver:text-gray-900">
                ...
                <div className="flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
                    {currentUser ? (
                        <p className="flex items-center justify-center gap-x-1 py-2 px-4 text-white fron-medium bg-gray-800 hover:bg-gray-700
